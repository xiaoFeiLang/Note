...
1.[stockForKVO addObserver:self forKeyPath:@"price" options:NSKeyValueObservingOptionNew|NSKeyValueObservingOptionOld context:NULL];

2.[testPerson setValue:[NSNumber numberWithInt:h+1] forKey:@"height"];
